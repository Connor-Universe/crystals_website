...
<div class="loginpage">
  <div class="content">
    <div class="logo fadeInDown wow"><a href="index.php?a=home"><img src="images/logo.png" alt="" /> rystals Exchange</a></div>
    <div class="loginwrappers">
      <div class="icon"><img src="styles/images/sigicon.png" alt="" /></div>
...
<tr>
 ...
 <td><input type=text class=inpts size=30 name=""   placeholder="U12345678"></td>
</tr>
<?php echo"$btc_address_error";?>
<tr>

 <td><input type=text class=inpts size=30 name="wallet"  placeholder="0x6c78b0ac68bf953c7fdbec0fd65bd5df933r8473"></td>
</tr>
...
<tr>
 ...
 <td><input type="email" name="email" class=inpts size=30 placeholder="Your E-mail Address" required></td>
</tr>
...
<tr>
 <td><input type=submit value="Register" class=sbmt></td>
  ...
  <div class="loginaction"><h4>Do you already have an account? </h4><a href="indexc30b.php?a=login" class="signup">Login Here</a></div>
 </div>
  </div>
</div>
<?php include "include/foot.php";?>

<!-- Mirrored from <?php echo"$site_name3";?>/?a=signup by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Apr 2021 09:56:31 GMT -->
</html>
