...
<h1 class="fadeInLeft wow">Frequently Asked Questions</h1>
      </div>
    </div>
      </div>
</div>
...
<div class="panel panel-default">
        ...
        <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Is <?php echo"$site_name3";?> a registered company?</a> </h4>
        </div>
        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
        <div class="panel-body">Yes, <?php echo"$site_name3";?> is registered in the USA and Panama as “<?php echo"$site_name3";?>” .</div>
        </div>
        </div>
        <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingTwo">
        <h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">How does <?php echo"$site_name3";?> earn profits for its members?</a> </h4>
        </div>
        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
        <div class="panel-body"><?php echo"$site_name3";?> is involved in cloud mining, which enables our company to earn Bitcoins and other currencies without mining hardware, software, electricity, or bandwidth.</div>
        </div>
        </div>
        <div class="panel panel-default">
        ...
        <div class="panel-body"> The minimum deposit amount is $1, the maximum you can deposit at one time is $100,000 Per each deposit , Surely you can make deposit higher than $100,000 by several deposits.</div>
        </div>
        </div>
        <div class="panel panel-default">
        ...
        <div class="panel-body">PM & Payeer minimum withdrawal amount : $0.1 , Dogecoin minimum withdrawal amount : $0.5 , Bitcoin minimum withdrawal amount : $5, Litecoin, Ethereum, Bitcoin Cash , Dash minimum withdrawal amount : $2.5 and There is no maximum limit for withdrawal.. </div>
        </div>
        </div>
        <div class="panel panel-default">
        ...
        <div class="panel-body"> Your deposit is automatically added after 1 network confirmations for cryptocurrencies but for PM and payeer this be add as soon as you paid funds.</div>
        </div>
        </div>
        <div class="panel panel-default">
...
<!-- Mirrored from <?php echo"$site_name3";?>/?a=faq by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Apr 2021 09:56:28 GMT -->
</html>
