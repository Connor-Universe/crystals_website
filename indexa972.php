...
<h1 class="fadeInLeft wow">Rules &amp; <span>Agreements</span></h1>
      </div>
    </div>
      </div>
</div>
...
<div class="inside_wrap rules">
  <div class="content">
    ...
    <p><span><?php echo"$site_name3";?></span> is not available to the general public and is opened only to the qualified members of <span><?php echo"$site_name3";?></span>, the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the <span><?php echo"$site_name3";?></span> and its Member.</p>
    ...
    <p>You agree that all information, communications, materials coming from <span><?php echo"$site_name3";?></span> are unsolicited and must be kept private, confidential and protected from any disclosure. Moreover, the information, communications and materials contained herein are not to be regarded as an offer, nor a solicitation for investments in any jurisdiction which deems non-public offers or solicitations unlawful, nor to any person to whom it will be unlawful to make such offer or solicitation.</p>
    <p>All the data giving by a member to <span><?php echo"$site_name3";?></span> will be only privately used and not disclosed to any third parties. <span><?php echo"$site_name3";?></span> is not responsible or liable for any loss of data.</p>
    ...
    <p><span><?php echo"$site_name3";?></span> is not responsible or liable for any damages, losses and costs resulting from any violation of the conditions and terms and/or use of our website by a member. You guarantee to <span><?php echo"$site_name3";?></span> that you will not use this site in any illegal way and you agree to respect your local, national and international laws.</p>
    ...
    <p><span><?php echo"$site_name3";?></span> reserves the right to accept or decline any member for membership without explanation.</p>
...
<!-- Mirrored from <?php echo"$site_name3";?>/?a=rules by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Apr 2021 09:56:33 GMT -->
</html>
